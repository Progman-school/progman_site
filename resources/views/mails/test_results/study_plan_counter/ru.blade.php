@component('mail::message')
    ...
    <div>
        ...
        <ul>
            ...
            <li>Mentor поможет вам выбрать лучшие технологии и шаги по их изучению для вашего конкретного проекта.</li>
            <li>Получите у наставника все необходимое программное обеспечение, воспользуйтесь его помощью для его установки и настройки компьютера.</li>
            ...
            <li>Mentor предоставляет вам пошаговый курс изучения языков/технологий, необходимых вам для проекта, и научит вас использовать их лично.</li>
            ...
            <li>Разверните готовое приложение, следуя подробным рекомендациям наставника.</li>
            <li>Создайте вместе с наставником свое портфолио по программированию, включая оформление страниц GitHub, профессиональное резюме и страницы в специальных сетях/сайтах для поиска работы в сфере ИТ.</li>
            ...
            <li>Вы готовы! Наставник поможет вам начать работу над проектом или собственный стартап, только не останавливайтесь, пока не добьетесь успеха.</li>
        </ul>
    </div>
    <br>
    <div class="important_line_info" style="padding: 10px">
